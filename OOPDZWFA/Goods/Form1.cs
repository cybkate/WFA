...
namespace Goods
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            productsList.Add(new Products(100.00, "Ukraine", "Watermelon", new DateTime(2022, 8, 11), " ", new DateTime(2023, 8, 11), 20, "kg"));
            productsList.Add(new Products(200.00, "India", "Tea", new DateTime(2022, 10, 4), " ", new DateTime(2022, 10, 8), 10, "l"));
            productsList.Add(new Products(300.00, "Switzerland", "Chocolate", new DateTime(2022, 10, 1), " ", new DateTime(2023, 1, 1), 5, "kg"));
            ...
            booksList.Add(new Books(100.00, "USA", "Jonathan Livingston Seagull", new DateTime(2022, 5, 16), " ", 500, "140", "Richard David Bach"));
            booksList.Add(new Books(200.00, "Ukraine", "Tygrolovy", new DateTime(2019, 2, 5), " ", 480, "2639", "Ivan Bahrianyi"));
            booksList.Add(new Books(300.00, "USA", "To Kill a Mockingbird", new DateTime(2015, 12, 30), " ", 300, "1384", "Harper Lee"));
